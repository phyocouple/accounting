...
class Appointment(models.Model):
    ...
    physician_id = fields.Many2one('hms.physician', ondelete='restrict', string='Physician', 
        index=True, help='Physician\'s Name', states=READONLY_STATES, tracking=True, default=_get_default_physician)
    ...
    planned_duration = fields.Float('Duration', compute="_get_planned_duration", inverse='_inverse_planned_duration',
        default=lambda self: self.env.company.acs_appointment_planned_duration, states=READONLY_CONFIRMED_STATES)
